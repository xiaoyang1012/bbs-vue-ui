    ...
    <div class="main-header">
      <div class="header-right-logo">
        ...
        <div @click="refresh" class="header-item-logo" v-if="!$store.state.collapsed">
          <img slot="avatar" src="@/assets/img/website-logo.png" alt="小仰的网络日志"
               style="width: 30px; height: 30px; margin-right: 10px; margin-bottom: 5px" />
          <span class="header-title">小仰的网络日志</span>
        </div>
      ...
      <div class="header-right-content">
        ...
        <!--          &lt;!&ndash; 注册Model &ndash;&gt;-->
        <!--          <Register/>-->
        <!--          &lt;!&ndash; 手机重置密码Model &ndash;&gt;-->
        <!--          <MobileResetPassword/>-->
        <!--          &lt;!&ndash; 邮箱重置密码Model &ndash;&gt;-->
        <!--          <EmailResetPassword/>-->
        <!--        </div>-->
      </div>
    </div>
