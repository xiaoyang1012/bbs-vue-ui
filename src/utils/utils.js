export default {
  ...
  timestampFormat(time) {
    const timestr = new Date(parseInt(time));
    ...
    return year + "-" + this.formatTime(month) + "-" + this.formatTime(date) + " " + this.formatTime(hour) + ":" + this.formatTime(minute) + ":" + this.formatTime(second);
  },
